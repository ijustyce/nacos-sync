...
public class NacosServerHolder extends AbstractServerHolderImpl<NamingService> {
    ...
    NamingService createServer(String clusterId, Supplier<String> serverAddressSupplier)
        ...
        properties.put(PropertyKeyConst.NAMING_CLIENT_BEAT_THREAD_COUNT, "" + clusterDO.getHeartbeatThreads());
        properties.put(PropertyKeyConst.NAMING_POLLING_THREAD_COUNT, "" + clusterDO.getPullThreadCount());
        ...
        properties.setProperty(PropertyKeyConst.ENDPOINT, serverList);
        properties.setProperty(PropertyKeyConst.ENDPOINT_PORT, "6801");
